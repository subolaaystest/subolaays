  ...
  <body>
    <div class="sign-up-steps-page">
      ...
      <div class="container">
        ...
        <form id="storeSellerProfle" method="post" action="{{ route('storeSellerProfle') }}" enctype="multipart/form-data" class="form-horizontal" role="form">
            {{ csrf_field() }}
                ...
                <div class="row mt-5">
                  ...
                  <div class="col">
                    <div class="building-box">
                      <input type="radio" name="seller_category_id" id="seller_category_id" value="{{ $one->id }}">
