...
@section('title', __('translate.editProduct'))
    ...
    <div class="main-content">
        ...
        <div class="add-product">
            <div class="add-product-head">
                <h1> {{ __('translate.editProduct') }} </h1>
            ...
            <form id="storeSellerProduct" method="post" action="{{ route('updateSellerProduct') }}" enctype="multipart/form-data" class="form-horizontal" role="form">
            {{ csrf_field() }}
                            ...
                            <div class="row row-cols-1 row-cols-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="niceselect SelectMainCategoryId" type="text" name="main_category_id" id="select-385">
                                            ...
                                            @foreach ($main_categories as $one)
                                                <option {{ $item->main_category_id == $one->id? 'selected' : '' }} value="{{ @$one->id }}">
                                                    {{ @$one->name }}
                                                </option>
                                            @endforeach
                                            @endisset
                                    ...
                                    <div class="input-number">
                                        <div class="form-group">
                                            ...
                                            <div class="input-number-control">
                                                ...
                                                <input type="number" id="input-715" value="{{ @$item->quantity_available }}" name="quantity_available" min="0" placeholder="2" />
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ @$item->sku }}" id="input-985" name="sku"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input-822"> {{ __('translate.minimumQuantityForNotice') }} </label>
                                <input class="form-control" type="number" name="count_alert" min="0" value="{{ @$item->count_alert }}" id="input-822"/>
                            </div>
                            ...
                            <div class="tab-content" id="tabs-832Content">
                                <div class="tab-pane fade show active" role="tabpanel" id="arabic-details-21" aria-labelledby="arabic-tab-21">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ @$item->translate('ar')->name }}" name="name_ar" id="input-644" placeholder="أكتب الإسم"/>
                                    </div>
                                </div>
                                <div class="tab-pane fade" role="tabpanel" id="english-details-21" aria-labelledby="english-tab-21">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ @$item->translate('en')->name }}" name="name_en" id="input-320" placeholder="أكتب الإسم"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-content" id="tabs-283Content">
                                <div class="tab-pane fade show active" role="tabpanel" id="arabic-details-112" aria-labelledby="arabic-tab-112">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" name="description_ar">{{ @$item->translate('ar')->description }}</textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade" role="tabpanel" id="english-details-112" aria-labelledby="english-tab-112">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" name="description_en">{{ @$item->translate('en')->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="step-3-details" role="tabpanel" aria-labelledby="step-3-details-tab">
                        <div class="add-product-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-2 align-items-start">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control productCostPrice" type="number" value="{{ @$item->price }}" name="price" min="0" id="input-222"/>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control discountPercentage" type="number" value="{{ @$item->discount_percentage }}" name="discount_percentage" min="0" id="input-18"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control priceAfterDiscount" type="number" value="{{ @$item->active_price }}" id="input-172" disabled />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="minimum_order" value="{{ @$item->minimum_order }}" min="0" id="input-813"/>
                                <div class="value-text"> {{ __('translate.riyal') }} </div>
                            </div>
                            <div class="d-flex justify-content-between" style="margin-top:-10px">
                                <div class="form-group">
                            ...
                            @isset($item->smart_prices)
                            @foreach($item->smart_prices as $one)
                                ...
                                <div class="row input_fields_wrap">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex justify-content-between flex-wrap">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <input class="form-control" value="{{ $one->from_quantity }}" type="number" min="0" name="smartFromQuantity[]">
                                                </div>
                                                <div class="d-flex align-items-center mb-2">
                                                    <label style="min-width:70px"> {{ __('translate.to') }} </label>
                                                    <input class="form-control" value="{{ $one->to_quantity }}" type="number" min="0" name="smartToQuantity[]">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" value="{{ $one->price }}" id="input-983" min="0" name="smartPrice[]" />
                                            <div class="value-text"> {{ __('translate.riyal') }} </div>
                                        </div>
                                    </div>
                                </div>
