...
@section('content')
    ...
    <form id="checkSellerCode" method="post" action="{{ route('checkSiteLoginCode') }}" enctype="multipart/form-data" class="form-horizontal" role="form">
    {{ csrf_field() }}
        ...
        <div class="bottom-form-text">
            <h5><a href="{{ route('reSendSellerLoginCode', ['mobile' => $_REQUEST['mobile']]) }}">
                {{ __('translate.reSendSiteLoginCode') }} </a></h5>
        </div>
    </form>
